      ...
      <section
        ...
        className={cn(
          ...
          banner.title
            ...
            : "h-[460px] sm:h-[500px] md:h-[560px] lg:h-[min(600px,68vh)] xl:h-[min(660px,72vh)] 2xl:h-[720px]"
        )}
      >
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#050b18] via-[#071029] to-[#050b18] py-10 sm:py-14 lg:py-16 xl:py-20">
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base font-medium text-slate-200 sm:text-lg">
