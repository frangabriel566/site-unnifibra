    ...
    <section id="unidades" className="relative py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mx-auto mt-5 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-sky-400/30 bg-sky-400/10 px-4 py-1.5 text-xs font-semibold text-sky-300 transition-colors hover:bg-sky-400/20"
            >
