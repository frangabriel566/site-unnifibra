...
export const siteConfig: SiteConfig = {
  ...
  appearance: {
    ...
    heroBanners: [
      ...
      },
      {
        ...
        title: "A internet que conecta sua vida",
        subtitle: "Velocidade e estabilidade para você navegar sem limites.",
        buttonText: "Ver Planos",
        buttonLink: "#planos",
        active: true,
        order: 2,
  ...
  benefits: [
    {
      id: "fibra-otica",
      icon: "Cable",
      title: "Internet 100% fibra óptica",
      description: "Conexão moderna, estável e de alta performance.",
      active: true,
      order: 1,
    },
    {
      ...
      description: "Planos de até 800MB para todas as necessidades.",
      active: true,
      order: 2,
    },
    {
      ...
      description: "Resposta rápida, ideal para jogos e videochamadas.",
      active: true,
      order: 3,
    },
    {
      ...
      description: "Atendimento rápido direto no seu celular.",
      active: true,
      order: 4,
    },
    {
      ...
      description: "Sem taxas escondidas para começar a usar.",
      active: true,
      order: 5,
    },
    {
      id: "equipamentos-comodato",
      icon: "Router",
      title: "Equipamentos em comodato",
      description: "Roteador, ONU e demais equipamentos inclusos.",
      active: true,
      order: 6,
    },
    {
      id: "casa-empresa",
      icon: "Building2",
      title: "Planos para casa e empresa",
      description: "Soluções sob medida para residências e negócios.",
      active: true,
      order: 7,
    },
    {
      id: "jogos-online",
      icon: "Gamepad2",
      title: "Ideal para jogos online",
      description: "Estabilidade e velocidade para suas partidas.",
      active: true,
      order: 8,
    },
    {
      ...
      description: "Assista em 4K sem travamentos.",
      active: true,
      order: 9,
    },
    {
      ...
      description: "Conexão confiável para reuniões e trabalho remoto.",
      active: true,
      order: 10,
    },
    {
      ...
      description: "Pessoas reais prontas para te ajudar.",
      active: true,
      order: 11,
    },
  ],
  ...
  differentials: [
    ...
    },
    {
      ...
      description: "Fibra óptica de ponta a ponta para máxima estabilidade.",
    },
    {
      id: "tecnologia-ponta",
      icon: "Cpu",
      title: "Tecnologia de ponta",
      description: "Equipamentos modernos e infraestrutura atualizada.",
    },
    {
      id: "planos-acessiveis",
      icon: "Wallet",
      title: "Planos acessíveis",
      description: "Preços justos para todos os perfis de cliente.",
    },
    {
      id: "suporte-rapido",
      icon: "Timer",
      title: "Suporte rápido",
      description: "Resolução ágil de problemas técnicos.",
    },
    {
      id: "sem-burocracia",
      icon: "FileCheck",
      title: "Sem burocracia",
      description: "Contratação simples, direto pelo WhatsApp.",
    },
    {
      id: "instalacao-agil",
      icon: "Rocket",
      title: "Instalação ágil",
      description: "Equipe pronta para instalar rapidamente.",
    },
    {
      id: "residencias-empresas",
      icon: "Building",
      title: "Internet para residências e empresas",
      description: "Planos pensados para cada tipo de uso.",
    },
    {
      id: "promocao-3-meses",
      icon: "Tag",
      title: "Promoção nos 3 primeiros meses",
      description: "Pague apenas R$ 59,90 por mês no início do contrato.",
    },
    {
      id: "equipamentos-inclusos",
      icon: "PackageCheck",
      title: "Equipamentos inclusos",
      description: "Roteador e ONU sem custo adicional.",
    },
  ],
  ...
  testimonials: [
    ...
    },
    {
      ...
      comment: "Instalação rápida e suporte muito atencioso.",
      rating: 5,
      active: true,
    },
    {
      ...
      comment: "Melhor provedor da região. Recomendo muito.",
      rating: 5,
      active: true,
    },
  ],
