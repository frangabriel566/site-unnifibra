  ...
  benefits: [
    {
      ...
      description: "Conexão moderna, estável e com alta performance.",
      active: true,
      order: 1,
    },
    {
      ...
      description: "Planos ideais para todos os tipos de uso, da casa ao negócio.",
      active: true,
      order: 2,
    },
    {
      ...
      description: "Mais estabilidade para jogos online, chamadas de vídeo e streaming.",
      active: true,
      order: 3,
    },
    {
      ...
      description: "Equipe preparada para instalar sua internet com rapidez.",
      active: true,
      order: 4,
    },
    {
      ...
      description: "Atendimento prático, rápido e humanizado.",
      active: true,
      order: 5,
    },
    {
      ...
      description: "Roteador, ONU e equipamentos necessários conforme o plano.",
      active: true,
      order: 6,
    },
    {
      ...
      description: "Assista filmes, séries e vídeos com mais qualidade.",
      active: true,
      order: 7,
    },
    {
      ...
      description: "Conexão confiável para reuniões, aulas e trabalho remoto.",
      active: true,
      order: 8,
    },
  ],
